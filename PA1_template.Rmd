...
Load data and create the dataframes used along the document:
...
**stepsPerInterval**: mean of steps of all days per time interval NA values are omitted
...
We can impute the NA using mean values in the 5-minutes interval for all days. 
We calculate the number of rows with **NA** values:
